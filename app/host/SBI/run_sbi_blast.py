...
sbi_params = {
    ...
    "anpe_fname_local": f"{settings.SBIPP_ROOT}/SBI_model_global.pt",  # trained sbi model
    "train_fname_local": f"{settings.SBIPP_PHOT_ROOT}/sbi_phot_global.h5",  # training set
